---
title: 'Ground-truthing forest disturbance detection algorithms with harvest records'
author:
...
main_findings:
  - "Change detection algorithms **underpreform** in the **Northern Forest region**, but there is ample potential for **improvement**."
  - '![](canopy.png){.main_pic}'
...
![_Table 1. Harvest detection performance based on a combined confusion matrix that includes results for three algorithms compared against the same harvest records. Values given are percentages of pixels calculated for each algorithm’s outputs separately._](Table2.png)
